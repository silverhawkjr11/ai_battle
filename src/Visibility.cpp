// Visibility.cpp - Line of sight calculations using Bresenham's algorithm
// Trees and rocks block LOS, water does not
...
// Alternative ray-line implementation
